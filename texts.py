...
dictionary = {'Кто/что?': ' Ричард Львиное Сердце', 'С кем/чем?': ' с Нурланом Сабуровым', 'Как?': ' неожиданно',
              ...
              'О чём?': ' о стаканах', 'Кого/что?': ' экстракт пробок',
              'Кто они?': ' инвесторы', 'Что делала?': ' грызла сапог',
              'Что он держал?': ' зарядку для телефона', 'Нет кого его?': ' попугая', 'Что делать?': ' петь Меладзе',
              'Каким?': ' луковым', 'Чем?': ' топором', 'Куда?': ' на полку', 'Какой предмет?': ' заколку',
              'Какому зданию?': ' зданию библиотеки книг про котиков', 'Что сделать?': ' облизнуть колено',
              'Чем заниматься?': ' плясать вприсядку', 'Какого?': ' колючего', 'Нет чего?': ' вагона метро',
              'Каким предметом?': ' топором', 'Какая?': ' похожая на ватрушку', 'Кто она?': ' продавщица пирожков',
              'Какого действия?': ' индийской дискотеки', 'Зачем?': ' чтобы соблазнить Моргенштерна',
              'Какого животного?': ' червя', 'Какими частями тела?': ' руками',
              ...
              'Что сделал?': ' уснул', 'Какие они?': 'красивые'}
