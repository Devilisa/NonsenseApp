...
<ScreenOne>:
    ...
    Button:
        ...
        size_hint: 0.8, 0.1
        on_release: app.root.button_sound.play_music()
    ...
    FloatLayout:
        ...
        FloatLayout:
            ...
            Slider:
                ...
                max: 100
                step: 1
                on_touch_up: app.root.background_music.set_volume(self.value / 100)
            Slider:
                size_hint: 0.7, 0.02
                background_horizontal: 'img/Настройки/Дорожка_Звук.png'
                cursor_image: 'img/Настройки/Трекер_Звук.png'
                ...
                max: 100
                step: 1
                on_touch_up: app.root.button_sound.set_volume(self.value / 100)
            Image:
...
class ScreenManagement(ScreenManager):
    button_sound = AudioAdapter("button_sound.mp3", False)
    background_music = AudioAdapter("background_music.mp3", True)
...
class ScreenSix(Screen):
    ...
    def AnimButton1(self, widget, *args):
        self.parent.button_sound.play_music()
        anim = Animation(top_hint=0.5, duration=0.3)
        anim.start(widget)
